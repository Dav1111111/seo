...
- **TouristTrip + AggregateRating + Review** в связке существенно повышают вероятность rich-сниппета у турпродукта.
...
сослался в ответе (web.dev/vitals, WCAG 2.2, schema.org/TouristTrip,
