...
- Title: 50-70 символов, с ключевым словом, привлекательный. Добавляй цифры, год, цены где уместно.
  Пример: "Экскурсия 33 водопада — джип-тур с обедом от 2300₽ | ЮК"
- Description: 140-160 символов, продающий, с УТП. С призывом к действию.
  Пример: "Джип-экскурсия к 33 водопадам без концертов. Чайная плантация, купание, обед. От 2300₽. Группы до 10 человек. Бронь онлайн."
- H1: естественный, с основным запросом, но не повторяет title дословно
- Для статей: outline из 5-8 H2, вступление (150-200 слов) на русском, ПРОСТЫМ языком
- FAQ: 5-8 реальных вопросов туристов с подробными ответами (100-200 слов каждый)
...
- Более 15 задач за раз (приоритизируй лучшие)
